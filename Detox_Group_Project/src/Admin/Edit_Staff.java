...
import Customer.Password_ChangeForCustomer;
...
public class Edit_Staff extends JFrame {
	...
	public Edit_Staff(Staff s) {
		...
		chooserDob.setBounds(188, 217, 289, 23);
...
//					public Staff (int id, String name, String email, String gender, String phno, String NRC, String position, String address, Date dob) {
		...
		btnUpdate.setBounds(386, 650, 134, 33);
...
//		String nrc = selectedStaff.getNrc();
...
//          comboBox1.setSelectedItem(matcher.group(2));
//          txtField.setText(matcher.group(3).replaceAll("[()]", "")); // Remove parentheses
//          txtNRCno.setText(matcher.group(4));
		...
		chooserDob.setDate(dob); // Set the date directly, should be java.util.Date
		txtn.setText(nrc);
	    txtNrc.setText(nrc);
	    if ("Male".equalsIgnoreCase(gender)) {
	        ...
	        btnGender.clearSelection(); // Clear selection if gender is invalid or not specified
	    }
