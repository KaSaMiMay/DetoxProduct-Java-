...
public class Admin_Profile extends JFrame {
	...
	public Admin_Profile(Staff s) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Admin_Profile.class.getResource("/Image/Logo-removebg-preview.png")));
...
//		        cboNrc1.setSelectedItem(s.getNRC()); 
		        txtnrc3.setText(s.getNRC()); 
