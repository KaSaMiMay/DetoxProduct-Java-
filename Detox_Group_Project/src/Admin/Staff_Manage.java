...
public class Staff_Manage extends JFrame {
	...
	public Staff_Manage(Staff s) throws SQLException {
		...
		txtNrc.setBounds(373, 227, 91, 26);
	 ...
	 comboBox2 = new JComboBox<>();
		...
		comboBox2.setBounds(174, 226, 58, 28);
...
//				});
		...
		comboBox1.setBounds(233, 226, 97, 28);
...
//					}
				    ...
				    String nrc = comboBox2Value + comboBox1Value + txtNrc.getText().trim();
