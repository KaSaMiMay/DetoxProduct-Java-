...
//		});
		...
		lblTotalprice.setBounds(247, 488, 127, 30);
		add(lblTotalprice);
		...
		lblTotalp.setBounds(384, 488, 143, 30);
		add(lblTotalp);
...
//					new Slip().setVisible(false);
		...
		lblTaxamont.setBounds(247, 528, 143, 30);
		add(lblTaxamont);
	 ...
	 lblCustomer = new JLabel("");
		...
		btnExit.setBounds(411, 615, 107, 33);
		add(btnExit);
...
//		                    System.out.println("Inserted successfully for row " + i);
		...
		btnPrint.setBounds(284, 615, 107, 33);
		add(btnPrint);
